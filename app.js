...
const CULTURE = [
  ...
  { e: '👩‍🏭', t: '공장에서 만날 사람들', b: '봉제·섬유는 일하는 사람의 <b>약 75%가 여성</b>입니다(2023년 기준). 전자도 비슷하게 여성이 많습니다.<br>' +
      '대부분 시골에서 도시로 온 <b>젊은 사람들</b>이고, 봉제 쪽은 <b>절반 넘게 35세 미만</b>이라는 조사가 있습니다.<br>' +
      '중간관리자로 가시면 <b>나보다 어린 여성 작업자</b>가 많을 가능성이 큽니다 — <b>em</b>으로 부르되 함부로 대하지 않는 것이 시작입니다.' },
...
const CULTAT = {
  // 일상 — 주제와 문화가 실제로 맞물리는 자리에만 붙인다
  '일상 1': 0,   // 인사와 호칭      → 호칭이 예의의 절반
  '일상 2': 1,   // 이름 묻고 답하기 → 이름은 뒤에서 부른다
  '일상 3': 18,  // 어느 나라        → 남과 북은 말이 다르다
  '일상 4': 17,  // 반갑습니다       → 한국 것을 이미 알고 있다 (말문 트기)
  '일상 6': 2,   // 헤어질 때        → 두 손으로
  '일상 10': 9,  // 나이와 시간      → 쉬는 날
