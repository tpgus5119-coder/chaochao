...
function showGuide() {
  ...
  sec('④', '카드 한 장 안의 모든 것', [
    ...
    '<b>hỏi와 ngã</b>는 채점은 하되 <b>문턱을 조금 높였습니다.</b> 이 둘은 <b>남부·중부에서 하나로 합쳐져</b> ' +
      '현지 사람들도 잘 가르지 않고 기계도 여기서 가장 많이 헷갈립니다. 그래서 틀렸다고 나오면 ' +
      '<b>그 사실을 함께 알려드립니다</b> — 못 맞혔다고 기죽을 일이 아닙니다.',
