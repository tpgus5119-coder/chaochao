...
const CULTAT = {
  // 일상 — 주제와 문화가 실제로 맞물리는 자리에만
  '일상 1': 0,   // 인사와 호칭      → 호칭이 예의의 절반
  '일상 2': 1,   // 이름 묻고 답하기 → 이름은 뒤에서 부른다
  '일상 3': 21,  // 어느 나라        → 남과 북은 말이 다르다
  '일상 4': 20,  // 반갑습니다       → 한국 것을 이미 알고 있다
  '일상 6': 2,   // 헤어질 때        → 두 손으로
  '일상 10': 9,  // 나이와 시간      → 쉬는 날
  '일상 12': 5,  // 하루 일과        → 오토바이가 다리
  '일상 13': 17, // 먹고 마시기      → 아침은 밖에서 사 먹는다
  '일상 14': 10, // 사고 팔기        → 돈 다루기
  '일상 15': 8,  // 숫자와 돈        → 설(Tết)이 일 년의 중심
  '일상 16': 13, // 어디에 있어요    → 신발과 집
  '일상 17': 12, // 가족             → 가족이 먼저
  '일상 19': 11, // 부탁하기         → 하지 않는 것이 좋은 일
  '일상 20': 15, // 어떤가요(평가)   → 축구가 국민 스포츠
  '일상 22': 7,  // 약속하고 마무리  → 차부터 한 잔
  // 직무
  '직무 1': 16,  // 회사와 사람들    → 공장에서 만날 사람들
  '직무 6': 4,   // 근태와 보고      → 점심 후 낮잠
  '직무 8': 18,  // 식당과 기숙사    → 한국 라면을 이미 먹고 있다
  '직무 9': 10,  // 큰 숫자와 월급   → 돈 다루기
  '직무 11': 14, // 전화와 연락      → 북부는 사계절, 남부는 두 계절
  '직무 21': 3,  // 전자 부품        → 회식과 건배
  '직무 25': 19, // 문화·행정 무렵    → 설 첫날에 하지 않는 것
  '직무 6': 4,
  '일상 11': 6,  // 요일             → 커피의 나라 (주말·쉬는 이야기)
};
