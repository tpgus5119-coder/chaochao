...
const GROUPS = [
  ...
  [d => !d.track && d.n <= 13, '시장에서 — 사고 팔기'],
  [d => !d.track && d.n <= 15, '일과 하루'],
  [d => !d.track && d.n <= 18, '부탁하고 약속하기'],
  [d => !d.track && d.n <= 20, '아플 때 — 약국과 병원'],
  [d => !d.track && d.n <= 24, '식당과 카페에서'],
  [d => !d.track && d.n <= 27, '길과 교통'],
  [d => !d.track && d.n <= 30, '가족과 고향'],
  [d => !d.track && d.n <= 32, '날씨와 색깔'],
  [d => !d.track && d.n <= 35, '쉬는 날과 명절'],
  [d => !d.track && d.n <= 38, '마음 말하기와 맞장구'],
  [d => !d.track,              '집과 살림'],
...
const CULTAT = {
  ...
  '일상 — 무슨 일 하세요': '베트남이라는 나라',
  '일상 — 했다 / 할 것이다': '지나온 길 — 왜 이렇게 되었나',
  '일상 — 가족 자랑과 반려동물': '아이가 있다면 — 학교',
  '일상 — 이름 묻고 답하기': '이름은 뒤에서 부른다',
  '일상 — 어느 나라, 어디 사세요': '남과 북 — 말도 결도 다릅니다',
