...
**x-toi.webp** · 나·저 (tôi)
> a single person icon with an arrow pointing from the person to themselves, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ten.webp** · 이름 (tên)
> a thought bubble above a person's head with a name tag inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-gi.webp** · 무엇 (gì)
> a speech bubble with a question mark inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-khong.webp** · 아니다 / ~입니까? (không)
> a red X mark over a checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cos.webp** · 있다 (có)
> a green checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-rat.webp** · 매우 (rất)
> a bar graph with a full bar, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nao.webp** · 어느 (nào)
> three identical objects, with one highlighted in a darker color and the others in light gray, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-kia.webp** · 저기 (kia)
> a person pointing with an arrow to a distant object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-the-nao.webp** · 어떻다·어때 (thế nào)
> a speech bubble with a question mark and a thought bubble with a question mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-lam.webp** · 아주 (말 끝에) (lắm)
> a bar graph with a full bar, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cung.webp** · ~도·또한 (cũng)
...
**x-biet.webp** · 알다 (biết)
> a lightbulb above a person's head, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mot-chut.webp** · 조금 (một chút)
> a bar graph with a very small portion of the bar filled, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hen-gap-lai.webp** · 또 만나요 (hẹn gặp lại)
> two people waving goodbye with a curved arrow indicating return, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-sau.webp** · ~후에·뒤 (sau)
> a person walking away with an arrow pointing behind them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-truoc.webp** · ~전에·앞 (trước)
> a person walking forward with an arrow pointing in front of them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-roi.webp** · 이미·했다 (rồi)
> a completed task with a checkmark and an arrow pointing to the past, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-maays.webp** · 몇 (적은 수) (mấy)
> A thought bubble above a person's head with a small number of question marks inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bao-nhieu.webp** · 얼마나·몇 (큰 수) (bao nhiêu)
> A thought bubble above a person's head with many question marks inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tat-ca.webp** · 전부·모두 (tất cả)
> Three identical objects, all in dark color, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-con.webp** · 남다·아직 있다 (còn)
> A box with one object inside, and an arrow pointing to the object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-muoi.webp** · 십 (20·30의 십) (mươi)
> A stack of ten identical items, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-luc.webp** · ~에 (시각) (lúc)
> A clock with an arrow pointing to a specific time, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thu-ba.webp** · 화요일 (thứ ba)
> A calendar icon with the number 3 highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thu-tu.webp** · 수요일 (thứ tư)
> A calendar icon with the number 4 highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thu-nam.webp** · 목요일 (thứ năm)
> A calendar icon with the number 5 highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thu-sau.webp** · 금요일 (thứ sáu)
> A calendar icon with the number 6 highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thu-bay.webp** · 토요일 (thứ bảy)
> A calendar icon with the number 7 highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ngayf.webp** · 날·일 (ngày)
> A sun icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-da.webp** · 이미 ~했다 (đã)
> A person walking away with a backward-pointing arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ddang.webp** · ~하는 중 (đang)
> A person in motion with a forward-pointing arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-se.webp** · ~할 것이다 (sẽ)
> A person looking forward with a forward-pointing arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-voi.webp** · ~와 함께 (với)
> two stick figures standing side by side, a double-headed arrow connecting them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hom-kia.webp** · 그저께 (hôm kia)
> a calendar with three days marked, the day before yesterday highlighted in a dark color, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bao-gio.webp** · 언제 (bao giờ)
> a question mark inside a thought bubble above a clock, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-sao.webp** · 왜·어떻게 (sao)
> a person with a large question mark inside a thought bubble, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lam-viec.webp** · 일하다 (làm việc)
> a person sitting at a desk with a computer, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-som.webp** · 일찍·이르다 (sớm)
> A person running with speed lines, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-moaix.webp** · 매·각각 (mỗi)
> Three identical objects, one of them highlighted in dark color, the others in light gray, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thuwowngf.webp** · 보통·자주 (thường)
> A person walking on a path with a circular arrow indicating repetition, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lam-on.webp** · 부디·좀 (부탁) (làm ơn)
> A speech bubble with a polite request, indicated by a small star or sparkle, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-can.webp** · 필요하다 (cần)
> A thought bubble above a person's head containing a desired object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-duoc-khong.webp** · ~해 주실 수 있나요 (được không)
> A speech bubble with a question mark and an open hand gesture (one simple mitten-like hand, fingers not detailed), simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-hay.webp** · ~하세요 (지시) (hãy)
> A person pointing forward with an arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hen.webp** · 약속하다·잡다 (hẹn)
> two people silhouettes with a calendar icon between them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ai.webp** · 누구 (ai)
> a silhouette of a person with a question mark inside a thought bubble, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-gi-nua.webp** · 또 뭐 (gì nữa)
> a thought bubble containing a plus sign and a question mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thoi.webp** · 그만·~만 (thôi)
> a hand-like shape making a stop gesture with an X mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nua.webp** · 더 (nữa)
> a small pile of blocks next to a larger pile of blocks, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-choi.webp** · 놀다 (chơi)
> a ball and a toy block, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-the-thao.webp** · 운동·스포츠 (thể thao)
> a soccer ball and a whistle, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nam-moi.webp** · 새해 (năm mới)
> a calendar page showing the first day of the year, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-hanh-phuc.webp** · 행복하다 (hạnh phúc)
> a heart symbol, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-suc-khoe.webp** · 건강 (sức khỏe)
> a strong muscular arm icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-bung.webp** · 배 (bụng)
> A simple outline of a human torso with the stomach area highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hong.webp** · 목구멍 (họng)
> a simple anatomical outline of a throat, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nay.webp** · 이·이것 (này)
> An arrow pointing to a single object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cho.webp** · ~에게 주다 (cho)
> A person giving an object to another person, indicated by an arrow from the giver to the receiver, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-xin.webp** · 청하다·주세요 (xin)
> A speech bubble with a question mark and an object inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chuyen.webp** · 생산 라인 (chuyền)
> a series of boxes on a conveyor belt with an arrow showing movement, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ca.webp** · 근무조·교대 (ca)
> a clock showing a shift block of time, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tang-ca.webp** · 잔업하다 (tăng ca)
> a clock with an extra segment highlighted in a dark color, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-so-luong.webp** · 수량 (số lượng)
> a group of items with a number symbol icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tong.webp** · 총·합계 (tổng)
> a calculator screen showing a sum, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nhan.webp** · 받다 (nhận)
> an arrow pointing towards a person, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-gui.webp** · 보내다 (gửi)
> an arrow pointing away from a person, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-het.webp** · 다 떨어지다 (hết)
> an empty box with an X mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-du.webp** · 충분하다 (đủ)
> a container filled to the brim with items, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-them.webp** · 더·추가로 (thêm)
> a plus sign icon next to an object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-kip.webp** · 제때 되다 (kịp)
> a person running to reach a clock before it rings, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-an-toan.webp** · 안전 (an toàn)
> a shield icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nguy-hiem.webp** · 위험하다 (nguy hiểm)
> a warning triangle with an exclamation mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-can-than.webp** · 조심하다 (cẩn thận)
> a person walking slowly with a cautious face, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cam.webp** · 금지하다 (cấm)
> a circle with a diagonal line through it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-chu-y.webp** · 주의하다 (chú ý)
> an eye icon looking at an object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nhanh.webp** · 빠르다·빨리 (nhanh)
> a person with speed lines behind them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-dung.webp** · 맞다 (đúng)
> a large green checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-sai.webp** · 틀리다 (sai)
> a large red X mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-giong.webp** · 같다 (giống)
> two identical objects side by side, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-khac.webp** · 다르다 (khác)
> two different shapes side by side, one circle and one square, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-xem.webp** · 보다 (xem)
> a person with wide eyes looking at a television screen, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-choax.webp** · 자리·부분 (chỗ)
> a single empty chair, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-the-nay.webp** · 이렇게 (thế này)
> an arrow pointing to an object right in front of the viewer, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cai-nay.webp** · 이것 (cái này)
> an arrow pointing to an object close to the viewer, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cai-kia.webp** · 저것 (cái kia)
> an arrow pointing to an object far away, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mays.webp** · 기계 (máy)
> a simple mechanical gear icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-dien.webp** · 전기 (điện)
> a lightning bolt icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-bao-cao.webp** · 보고하다 (báo cáo)
> a speech bubble containing a document icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ddeans.webp** · 도착하다 (đến)
> an arrow pointing to a destination marker, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-xin-phep.webp** · 양해를 구하다 (xin phép)
> a speech bubble containing a question mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dung-gio.webp** · 제시간에 (đúng giờ)
> a clock showing exactly twelve o'clock, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-vawngs.webp** · 결근하다·자리 비우다 (vắng)
> an empty chair with a large X mark over it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-co-gang.webp** · 열심히 하다 (cố gắng)
> a person with a determined face expression, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-bang.webp** · 표·판 (bảng)
> a rectangular whiteboard, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-so.webp** · 번호·숫자 (số)
> a symbol representing a generic number, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ddown.webp** · 전표·주문서 (đơn)
> a paper document with lines, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nghi-trua.webp** · 점심 휴식 (nghỉ trưa)
> a sun icon next to a fork and spoon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-phong.webp** · 방 (phòng)
> a simple square representing a room, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-taangf.webp** · 층 (tầng)
> a multi-story building with an arrow pointing to one level, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thangs.webp** · 달·월 (tháng)
> a calendar page, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thuwowngr.webp** · 상여금·보너스 (thưởng)
> a gift box with a ribbon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tawng.webp** · 오르다·늘다 (tăng)
> an arrow pointing upwards, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-giam.webp** · 줄다·내리다 (giảm)
> an arrow pointing downwards, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-phan-tram.webp** · 퍼센트 (phần trăm)
> a percentage sign icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bao-hiem.webp** · 보험 (bảo hiểm)
> a shield icon protecting a house, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thueas.webp** · 세금 (thuế)
> a coin with a minus sign, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-khu.webp** · 구역 (khu)
> a map section marked with a boundary, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thawngr.webp** · 곧장·똑바로 (thẳng)
> a straight arrow pointing forward, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-quay-lai.webp** · 되돌아가다 (quay lại)
> a U-turn arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-so-dien-thoai.webp** · 전화번호 (số điện thoại)
> a smartphone icon with a numeric keypad, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-alo.webp** · 여보세요 (alô)
> a speech bubble containing a telephone icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-baanj.webp** · 바쁘다 (bận)
> a person surrounded by many tasks and papers, looking stressed, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ranh.webp** · 한가하다 (rảnh)
> a person sitting comfortably in a chair with a relaxed expression, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lien-lac.webp** · 연락하다 (liên lạc)
> two people connected by a zigzag arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-khuy.webp** · 단춧구멍 (khuy)
> a fabric with a buttonhole, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mau.webp** · 샘플·견본 (mẫu)
> a single shirt icon representing a sample, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-gau.webp** · 밑단 (gấu)
> the bottom hem of a garment, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-than-truoc.webp** · 앞판 (thân trước)
> the front view of a shirt silhouette, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-than-sau.webp** · 뒷판 (thân sau)
> the back view of a shirt silhouette, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cowx.webp** · 사이즈·치수 (cỡ)
> three shirts of different sizes side by side, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-vat-so.webp** · 오버록 치다 (vắt sổ)
> a zigzag stitch pattern on the edge of a fabric, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thao.webp** · 뜯다·풀다 (tháo)
> a seam with an X mark over it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nhat-chi.webp** · 실밥 따다 (nhặt chỉ)
> a loose thread being pulled away from fabric, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-loi.webp** · 불량·오류 (lỗi)
> a garment with a large red X mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chat-luong.webp** · 품질 (chất lượng)
> a star icon representing high quality, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-san-pham.webp** · 제품 (sản phẩm)
> a finished shirt on a hanger, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ddatj.webp** · 합격이다 (đạt)
> a green checkmark icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-lam-lai.webp** · 다시 하다 (làm lại)
> a circular arrow indicating redo, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-baanr.webp** · 더럽다·얼룩지다 (bẩn)
> a fabric with a dark spot stain, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cang-chi.webp** · 실 장력 (căng chỉ)
> a thread being pulled taut between two points, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chinh.webp** · 조정하다 (chỉnh)
> a dial being turned by an arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-deu.webp** · 고르다·균일하다 (đều)
> perfectly aligned parallel lines, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ban-cat.webp** · 재단대 (bàn cắt)
> a large flat table with fabric on top, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lop.webp** · 겹·층 (lớp)
> multiple layers of fabric stacked, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lot.webp** · 안감 (lót)
> an inner lining piece of a garment, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-mex.webp** · 심지 (mex)
> a piece of fusible interfacing fabric, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-boj.webp** · 바택 (bọ)
> a reinforced bar-tack stitch on fabric, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-phu-lieu.webp** · 부자재 (phụ liệu)
> a small pile of buttons and thread, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-sot.webp** · 누락되다·빠뜨리다 (sót)
> a row of three items with one empty space marked with a large X, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-doi.webp** · 바꾸다 (đổi)
> two different objects with a double-headed arrow between them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-loai.webp** · 등급·종류 (loại)
> three different shapes in a row with one highlighted in a dark color, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hoan-thanh.webp** · 완성하다 (hoàn thành)
> a checklist with a large checkmark next to a completed task, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dan.webp** · 붙이다 (dán)
> a sticker being placed onto a flat surface, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-sach.webp** · 깨끗하다 (sạch)
> a sparkling clean plate with a small star icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-xanh.webp** · 파랗다·푸르다 (xanh)
> a solid blue square, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dam.webp** · 진하다 (đậm)
> a color swatch showing a very dark shade, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nhat.webp** · 연하다 (nhạt)
> a color swatch showing a very light, pale shade, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lo.webp** · 걱정하다 (lo)
> a person with a thought bubble containing a storm cloud, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chan.webp** · 지루하다·질리다 (chán)
> a person with a bored facial expression and slumped shoulders, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thoai-mai.webp** · 편안하다 (thoải mái)
> a person sitting in a relaxed posture with a smile, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cang-thang.webp** · 긴장되다·스트레스 (căng thẳng)
> a person with a stressed face and a lightning bolt icon above the head, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nho-nha.webp** · 집이 그립다 (nhớ nhà)
> a person with a thought bubble containing a house, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-gioi.webp** · 잘한다·유능하다 (giỏi)
> a person with a large star icon above, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tuyet-voi.webp** · 훌륭하다 (tuyệt vời)
> a person with a big happy smile and a gold star icon above their head, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-kheo.webp** · 솜씨 좋다 (khéo)
> a person creating a beautiful origami crane, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-dowr.webp** · 서툴다·못하다 (dở)
> a broken or messy painting with a large red X over it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ghe.webp** · 엄청·대단히 (ghê)
> a thermometer with the red liquid level at the very top, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-quen.webp** · 익숙하다·아는 사이다 (quen)
> two people smiling and waving at each other, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cung-nhau.webp** · 함께·다 같이 (cùng nhau)
> two stick figures standing side by side, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-mowif.webp** · 초대하다·권하다 (mời)
> a speech bubble with an open door icon inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-khach.webp** · 손님 (khách)
> a person wearing a hat arriving at a door, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-vui-ve.webp** · 즐겁다 (vui vẻ)
> a face with a big happy smile, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ngot.webp** · 달다 (ngọt)
> a sugar cube icon with a happy face, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ddawngs.webp** · 쓰다 (đắng)
> a person drinking coffee with a bitter, frowning face, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tai.webp** · 설익힌·레어 (tái)
> a piece of meat that is half red and half brown, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-xe.webp** · 차·탈것 (xe)
> a simple side-view silhouette of a car, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dia-chi.webp** · 주소 (địa chỉ)
> a map pin icon on a paper, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-so-nha.webp** · 번지·집 번호 (số nhà)
> a house icon with a number plate on the door, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-noi.webp** · 곳·장소 (nơi)
> a location pin icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-den-noi.webp** · 도착하다 (đến nơi)
> a person standing at a destination point with a flag, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cam-bien.webp** · 센서 (cảm biến)
> a small electronic chip with a signal wave icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chay-thu.webp** · 시운전하다 (chạy thử)
> a machine with a forward arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tinh-dien.webp** · 정전기 (tĩnh điện)
> a lightning bolt icon near a metal surface, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-kho.webp** · 마르다·건조하다 (khô)
> a cracked dry earth icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-am.webp** · 습하다 (ẩm)
> a water droplet icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-toc-do.webp** · 속도 (tốc độ)
> a speedometer icon with a needle, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-muc-tieu.webp** · 목표 (mục tiêu)
> a target with an arrow in the center, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-san-luong.webp** · 생산량 (sản lượng)
> a bar chart rising upwards, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tiep-tuc.webp** · 계속하다 (tiếp tục)
> a circular arrow icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ke-hoach.webp** · 계획 (kế hoạch)
> a clipboard with a checklist, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bao.webp** · 알리다 (báo)
> a speech bubble with an exclamation mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tai-lieu.webp** · 자료 (tài liệu)
> a stack of papers, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chu.webp** · 글자 (chữ)
> a single character icon on a paper, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ddawtj.webp** · 주문하다·예약하다 (đặt)
> a calendar with a checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cong-tac.webp** · 출장 (công tác)
> a suitcase with a plane icon above it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dat-phong.webp** · 방을 예약하다 (đặt phòng)
> a calendar page with a checkmark on a specific date and a bed icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hoan.webp** · 연기되다·미뤄지다 (hoãn)
> a calendar with an arrow pointing from a closer date to a further date, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-hon.webp** · ~보다 더 (hơn)
> a small box next to a larger box with an upward arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tai-khoan.webp** · 계좌 (tài khoản)
> a bank card with a shield icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ty-gia.webp** · 환율 (tỷ giá)
> a scale balancing two different currency symbols, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-phi.webp** · 수수료 (phí)
> a coin dropping into a piggy bank, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dang-ky.webp** · 등록하다·신청하다 (đăng ký)
> a pen icon on a document with a checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cham-chi.webp** · 성실하다·부지런하다 (chăm chỉ)
> a person with a determined face and a stack of books, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-noi-quy.webp** · 사규·규정 (nội quy)
> a document with a red stamp icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-giu.webp** · 지키다·유지하다 (giữ)
> a lock icon being held, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-gon-gang.webp** · 단정하다·정돈되다 (gọn gàng)
> a neatly stacked pile of books, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thai-do.webp** · 태도 (thái độ)
> a face showing a neutral but polite expression, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nghiem-tuc.webp** · 진지하다·엄정하다 (nghiêm túc)
> a face with a straight line mouth and focused eyes, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nho.webp** · 부탁하다 (nhờ)
> a speech bubble containing a question mark pointing towards another person, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ton-trong.webp** · 존중하다 (tôn trọng)
> two people bowing slightly to each other, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-hoi-tham.webp** · 안부를 묻다 (hỏi thăm)
> a speech bubble with a heart icon inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-che.webp** · 흉보다·깎아내리다 (chê)
> a speech bubble with a thumbs down icon inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dua.webp** · 농담하다 (đùa)
> a face laughing with tears of joy, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-than.webp** · 친하다 (thân)
> two stick figures standing close together, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chuc.webp** · 기원하다·빌다 (chúc)
> a speech bubble with a star icon inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ep.webp** · 강요하다 (ép)
> a person being pushed by a heavy arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tang-hai.webp** · 2차 (tăng hai)
> a number 2 icon next to a coffee cup or glass, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bua.webp** · 끼니·식사 자리 (bữa)
> a plate with a fork and spoon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-qua.webp** · 너무·정말 (quá)
> a thermometer with liquid level at the very top, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-xin-nghi.webp** · 휴가를 신청하다 (xin nghỉ)
> a person with a speech bubble containing a calendar with a red cross on a date, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-phep-nam.webp** · 연차 (phép năm)
> a calendar with a suitcase icon on it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ly-do.webp** · 이유 (lý do)
> a person with a thought bubble containing a question mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-viec-gap.webp** · 급한 일 (việc gấp)
> a person running with speed lines, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-doi-lich.webp** · 일정을 바꾸다 (đổi lịch)
> a calendar with a curved arrow pointing from one date to another, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-sap.webp** · 곧 ~하려 하다 (sắp)
> a person standing in front of a finish line with an arrow pointing forward, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nhac.webp** · 일깨우다·챙겨 말하다 (nhắc)
> a person with a speech bubble containing an exclamation mark pointing to another person, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nham.webp** · 착각하다·잘못 알다 (nhầm)
> a person with a thought bubble containing two different objects swapped, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-lowx.webp** · 그만 ~해 버리다 (lỡ)
> a broken glass on the floor with an X mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-co-y.webp** · 고의로 (cố ý)
> a person with a thought bubble containing a target, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-vo-y.webp** · 실수로·무심코 (vô ý)
> a person with a surprised facial expression and a dropped item, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tha-loi.webp** · 용서하다 (tha lỗi)
> a person with a speech bubble containing a heart, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-lan.webp** · 번·회 (lần)
> a circular arrow around a counter icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-sua-sai.webp** · 잘못을 바로잡다 (sửa sai)
> an eraser icon moving over a written mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-kinh-nghiem.webp** · 경험 (kinh nghiệm)
> a brain icon with many connections, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bo-qua.webp** · 넘어가 주다 (bỏ qua)
> an arrow jumping over an obstacle, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-that.webp** · 정말로·진심으로 (thật)
> a person with a sincere and honest facial expression, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thu-viec.webp** · 수습 (thử việc)
> a person with a small badge next to a large badge, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-chinh-thuc.webp** · 정식의 (chính thức)
> a document with a stamp, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-luong-co-ban.webp** · 기본급 (lương cơ bản)
> a stack of coins with a base line, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thoi-han.webp** · 기한 (thời hạn)
> an hourglass, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-gia-han.webp** · 연장하다 (gia hạn)
> an hourglass with an arrow extending the sand flow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-dieu-khoan.webp** · 조항 (điều khoản)
> a document with numbered list lines, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-quyen-loi.webp** · 권리·복리 (quyền lợi)
> a gift box icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nghia-vu.webp** · 의무 (nghĩa vụ)
> a person carrying a heavy box, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ky.webp** · 꼼꼼히·신중히 (kỹ)
> a person with a magnifying glass looking closely, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-phu-cap.webp** · 수당 (phụ cấp)
> a coin added to a pile of coins, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ngay-cong.webp** · 근무 일수 (ngày công)
> a calendar with marked work days, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tong-cong.webp** · 총합·합계 (tổng cộng)
> a calculator showing a sum, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thac-mac.webp** · 의문·궁금한 점 (thắc mắc)
> a person with a large question mark inside a thought bubble above their head, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lao-dong.webp** · 노동 (lao động)
> a person holding a hammer and a wrench, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lanh-su-quan.webp** · 영사관 (lãnh sự quán)
> a building with a national flag on top, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-han.webp** · 기한 (hạn)
> a calendar with a red circle on a specific date, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-qua-han.webp** · 기한이 지나다 (quá hạn)
> a calendar with a red X over a date and an arrow pointing past it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-y-te.webp** · 의료 (y tế)
> a medical cross symbol, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cap-cuu.webp** · 응급 (cấp cứu)
> an ambulance icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-khoi.webp** · (병이) 낫다 (khỏi)
> a person smiling with a thermometer removed, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thay.webp** · 발견하다·보이다 (thấy)
> an eye icon looking at a magnifying glass, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-bao-mat.webp** · 분실 신고하다 (báo mất)
> a wallet icon with a large red X over it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-binh-tinh.webp** · 침착하다 (bình tĩnh)
> a person with a calm, neutral facial expression, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-donj.webp** · 치우다·정리하다 (dọn)
> a broom and a dustpan, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nuoc-ngoai.webp** · 외국 (nước ngoài)
> a globe with an airplane flying over it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-visa.webp** · 비자 (visa)
> a passport with a stamp inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thuea.webp** · 빌리다·세내다 (thuê)
> a house with a coin icon above it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-van-hoa.webp** · 문화 (văn hóa)
> a traditional hat and a musical instrument, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-thoi-quen.webp** · 습관 (thói quen)
> a person brushing teeth repeatedly, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-co-len.webp** · 힘내라 (cố lên)
> a person with a determined face and flexed arm, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mang.webp** · 통신망·인터넷 (mạng)
> a globe icon connected by lines to a computer, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cuoc.webp** · 요금 (cước)
> a coin icon inside a speech bubble, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-goi-cuoc.webp** · 요금제 (gói cước)
> a package box with a price tag on it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nap-tien.webp** · (요금을) 충전하다 (nạp tiền)
> a coin moving into a phone icon with an arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mien-phi.webp** · 무료 (miễn phí)
> a price tag with a red X over the price, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ma.webp** · 코드·번호 (mã)
> a barcode icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-anh-trai.webp** · 형·오빠 (anh trai)
> A simple icon of an older male figure, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-chi-gai.webp** · 누나·언니 (chị gái)
> A simple icon of an older female figure, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-em-trai.webp** · 남동생 (em trai)
> A simple icon of a younger male figure, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tinh.webp** · 성(지방 행정구역) (tỉnh)
> a map showing a specific administrative region highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-mien.webp** · 지방·권역 (miền)
> a map divided into three distinct colored zones, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-mien-bac.webp** · 북부 (miền Bắc)
> a map with an arrow pointing to the top section, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-mien-nam.webp** · 남부 (miền Nam)
> a map with an arrow pointing to the bottom section, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-sinh-nam.webp** · ~년생 (sinh năm)
> a baby icon next to a calendar year, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-doc-than.webp** · 미혼이다 (độc thân)
> one person standing alone, others faded in grey, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mua.webp** · 계절·철 (mùa)
> a tree showing four distinct seasonal changes in a circle, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-uot.webp** · 젖다 (ướt)
> a shirt with water droplets on it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cuoi.webp** · 끝·마지막 (cuối)
> a line with an arrow pointing to the very end, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cuoi-tuan.webp** · 주말 (cuối tuần)
> a calendar showing the last two days highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ke.webp** · 이야기해 주다 (kể)
> a person with a speech bubble containing a story icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-di-choi.webp** · 놀러 가다 (đi chơi)
> a person with an arrow pointing towards a park, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tran.webp** · 경기·판 (trận)
> a soccer ball on a field, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hoa.webp** · 비기다 (hòa)
> two teams with equal sized bars, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ty-so.webp** · 스코어·점수 (tỷ số)
> a scoreboard showing two numbers, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-thu.webp** · 해 보다·시험 삼아 (thử)
> a magnifying glass over an object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-truoc-het.webp** · 우선·먼저 (trước hết)
> a sequence of steps where the first step is highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ddos.webp** · 그것·그 (đó)
> an arrow pointing to a distant object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-sau-do.webp** · 그다음에 (sau đó)
> an arrow pointing from one step to the next, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tung.webp** · 하나씩·각각 (từng)
> a row of items with only one highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-theo.webp** · 따르다·~대로 (theo)
> a person following a path marked by arrows, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cach.webp** · 방법 (cách)
> a lightbulb icon inside a gear, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-dung-cach.webp** · 올바른 방법으로 (đúng cách)
> a gear with a green checkmark next to it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ro-rang.webp** · 분명하게 (rõ ràng)
> a blurry shape transforming into a sharp clear shape with an arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tien-do.webp** · 진도·진행 (tiến độ)
> a progress bar filling up with an arrow pointing forward, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-lau.webp** · 오래 걸리다 (lâu)
> a large hourglass with sand flowing slowly, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bao-lau.webp** · 얼마나 오래 (bao lâu)
> an hourglass with a question mark inside a thought bubble, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-con-lai.webp** · 남은 것 (còn lại)
> a group of items where only one is colored and the rest are grey, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-van-de.webp** · 문제 (vấn đề)
> a large red exclamation mark inside a triangle, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-giai-quyet.webp** · 해결하다 (giải quyết)
> a puzzle piece fitting into a gap, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ngay.webp** · 즉시·바로 (ngay)
> a lightning bolt icon pointing at a clock, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bao-ngay.webp** · 즉시 보고하다 (báo ngay)
> a speech bubble with a lightning bolt inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-gop-y.webp** · 의견을 주다·피드백하다 (góp ý)
> two speech bubbles pointing at each other, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nhe-nhang.webp** · 부드럽게 (nhẹ nhàng)
> a soft feather icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-rieng.webp** · 따로·개인적으로 (riêng)
> a single person standing apart from a grey group, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-truoc-mat.webp** · 면전에서·앞에서 (trước mặt)
> two people standing face to face, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-mat-mat.webp** · 체면을 잃다 (mất mặt)
> a person with a sad face covering their eyes, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-y.webp** · 뜻·의도 (ý)
> a thought bubble with a lightbulb inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-hieu-y.webp** · 뜻을 알아듣다 (hiểu ý)
> two people with matching thought bubbles, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tin-tuong.webp** · 신뢰하다 (tin tưởng)
> a shield icon with a heart inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tu-hao.webp** · 자랑스럽다 (tự hào)
> a person standing tall with a proud smile, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tien-bo.webp** · 발전하다·늘다 (tiến bộ)
> a small person next to a larger person on a rising arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-xuat-sac.webp** · 뛰어나다 (xuất sắc)
> a gold star icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ca-nhom.webp** · 팀 전체 (cả nhóm)
> a group of people all colored in, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-phat-huy.webp** · 발휘하다 (phát huy)
> a rocket launching upwards, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chuong-trinh.webp** · 순서·프로그램 (chương trình)
> a list icon with checkmarks, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-y-kien.webp** · 의견 (ý kiến)
> a speech bubble with a pencil icon inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dong-y.webp** · 동의하다 (đồng ý)
> two people with matching checkmarks in speech bubbles, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-quyet-dinh.webp** · 결정하다 (quyết định)
> a lightbulb glowing above a person's head, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ket-luan.webp** · 결론 (kết luận)
> a puzzle piece fitting into the final slot of a frame, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-coi.webp** · 경적 (còi)
> a car horn icon with sound waves radiating, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tranh-xa.webp** · 멀리 피하다 (tránh xa)
> a person moving away from a hazard sign with an arrow pointing away, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-khu-vuc.webp** · 구역 (khu vực)
> a square boundary line on the ground, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nhap.webp** · 들이다·입력하다 (nhập)
> a box with an arrow pointing inside, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-phieu.webp** · 전표·표 (phiếu)
> a paper document with a checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-ton-kho.webp** · 재고 (tồn kho)
> a warehouse shelf filled with boxes, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-vi-tri.webp** · 위치 (vị trí)
> a map pin icon on a grid, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-bien-ban.webp** · 확인서·조서 (biên bản)
> a document with a signature line and a seal, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-dung-hen.webp** · 약속대로·제때 (đúng hẹn)
> a clock showing a specific time with a checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-hu.webp** · 망가지다 (hư)
> a machine with a large X mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ddeanf.webp** · 배상하다 (đền)
> a person giving money to another person with an arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-khieu-nai.webp** · 클레임을 걸다 (khiếu nại)
> a speech bubble containing an exclamation mark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tieu-chuan.webp** · 기준·표준 (tiêu chuẩn)
> a ruler and a checkmark, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-tach.webp** · 분리하다 (tách)
> one object splitting into two with arrows pointing away from each other, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tach-rieng.webp** · 따로 빼다 (tách riêng)
> a group of items with one item moved away and highlighted, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-daaus.webp** · 표시·부호 (dấu)
> a red circle mark on a paper, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-lan-cuoi.webp** · 마지막으로·최종 (lần cuối)
> a calendar with the last day marked with a cross, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nguyen.webp** · 원래대로·그대로 (nguyên)
> a whole apple, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-giu-nguyen.webp** · 그대로 두다 (giữ nguyên)
> an object inside a glass box, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-nhu-moi.webp** · 새것처럼 (như mới)
> an old item next to a shiny new item, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-huong-dan.webp** · 지침·안내 (hướng dẫn)
> a book with an arrow pointing to a page, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chu-thich.webp** · 주석·설명 달기 (chú thích)
> a speech bubble pointing to a specific part of an object, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-trang.webp** · 페이지·쪽 (trang)
> an open book, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-dong.webp** · 줄·행 (dòng)
> a single horizontal line on a page, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-muc.webp** · 항목 (mục)
> a bulleted list icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-tim-hieu.webp** · 알아보다 (tìm hiểu)
> a magnifying glass over a book, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cap-nhat.webp** · 업데이트하다 (cập nhật)
> a circular arrow icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-phien-ban.webp** · 버전·판 (phiên bản)
> a stack of boxes labeled with different sizes, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-chay.webp** · 녹아 흐르다 (chảy)
> a solid block turning into liquid, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nong-chay.webp** · 녹다 (nóng chảy)
> a flame under an ice cube, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-bo.webp** · 기판(보드) (bo)
> a computer circuit board, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-hien-thi.webp** · 표시되다·뜨다 (hiển thị)
> a computer screen showing a bright icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-phan-mem.webp** · 소프트웨어 (phần mềm)
> a gear icon inside a screen, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-mem.webp** · 부드럽다 (mềm)
> a fluffy pillow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-cai-dat.webp** · 설치하다·설정하다 (cài đặt)
> a gear icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-du-lieu.webp** · 데이터 (dữ liệu)
> a database server icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-luu.webp** · 저장하다 (lưu)
> a floppy disk icon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-khoi-dong-lai.webp** · 다시 켜다·재부팅 (khởi động lại)
> a power button with a circular arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ma-loi.webp** · 불량 코드 (mã lỗi)
> a computer screen with a red warning symbol, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-diem.webp** · 점·점수 (điểm)
> a scoreboard showing a high number, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-ho.webp** · 틈이 벌어지다 (hở)
> two solid blocks with a visible gap between them and arrows pointing away from the gap, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-keu.webp** · 소리가 나다 (kêu)
> a bell icon with radiating sound waves, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-noi-dat.webp** · 접지하다 (nối đất)
> an electrical wire pointing down to a ground symbol, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-nhiet.webp** · 열 (nhiệt)
> a thermometer with a high red level, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-do-am.webp** · 습도 (độ ẩm)
> a water droplet icon next to a percentage scale, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-cach-dien.webp** · 절연하다 (cách điện)
> a lightning bolt symbol inside a circle with a large X over it, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-kien.webp** · 짝·건 (포장 단위) (kiện)
> a cardboard box tied with a ribbon, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
...
**x-doi-chieu.webp** · 대조하다 (đối chiếu)
> two documents side by side with a magnifying glass hovering over them, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-chong.webp** · 막다·방지하다 (chống)
> a shield icon blocking an incoming arrow, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters

**x-chong-am.webp** · 방습하다 (chống ẩm)
> a shield icon blocking a water droplet, simple flat illustration, soft pastel colors, thick outlines, plain white background, no text, no letters
