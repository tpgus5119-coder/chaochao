...
사용:
    ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen_verified.py             # 안전 모드
    ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen_verified.py --replace   # 실제 자리
    ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen_verified.py --limit 50  # 시간 가늠용

밤새 돌리기:
    nohup ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen_verified.py \
