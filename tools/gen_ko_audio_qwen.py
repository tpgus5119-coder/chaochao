...
사용:
    ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen.py            # 안전 모드, audio/ko-qwen/
    ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen.py --replace  # 실제 자리(audio/ko-f/)에 굽기
    ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen.py --limit 50 # 먼저 50개만 (시간 가늠용)

밤새 돌리기:
    nohup ~/짜오짜오/음성-도구/qwen-tts-env/bin/python tools/gen_ko_audio_qwen.py > logs/ko_audio_qwen.log 2>&1 &
"""
