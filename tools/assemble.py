...
# 차례는 **한 주제가 한 덩어리**가 되게 짰다. 교재들(Colloquial Vietnamese, Tiếng Việt 123,
# VSL 등)이 모두 '장소·상황' 단위로 묶고 그 이름을 단원 제목으로 쓴다 — 그 방식을 따랐다.
# 묶음 차례는 '그날까지 배운 낱말로만' 규칙을 가장 적게 어기는 순서로 골랐다.
# 어기는 낱말 22개는 표지에 '미리 나오는 말'로 뜻과 함께 적어 준다.
DAILY_HEAD = [1,2,3,4,5,6,     # 첫 인사와 자기소개
              ...
              17,18,20,        # 부탁하고 약속하기
              16,47,           # 아플 때 — 약국과 병원
              12,48]           # 식당과 카페에서 (여기서 시작)
DAILY_MID  = [76,77,           # 식당과 카페에서 (이어서)
              14,42,80,        # 길과 교통
              15,71,72,        # 가족과 고향
              41,43]           # 날씨와 색깔
DAILY_TAIL = [45,49,73,        # 쉬는 날과 명절
              44,74,75,        # 마음 말하기와 맞장구
              46,50,78,79]     # 집과 살림
