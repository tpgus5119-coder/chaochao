...
FRAME = re.compile(
    r"(에대한설명으로맞는것은무엇입니까|에대한설명으로맞는것은|으로맞는것은무엇입니까"
    r"|으로알맞은것은무엇입니까|으로알맞은것을고르십시오|로알맞은것을고르십시오"
    r"|알맞은것을고르십시오|것을고르십시오|무엇이라고합니까|무엇입니까|어디입니까"
    r"|몇월며칠입니까|물음에답하십시오|다음물음에알맞은답을고르십시오)")
