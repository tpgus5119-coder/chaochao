...
# 이 맥의 시스템 시계가 2026-09-13부터 이미 베트남시간(Asia/Ho_Chi_Minh)이라
# 아래 시각은 변환 없이 이 맥의 시계 그대로 읽으면 된다.
#
#   저녁 8시   기사 받기 · 카드 만들기 (펴낸날 = 내일)
#   새벽 3시   tools/card_ship.sh 가 바탕화면 정리 + 앱 등록
#
...
say "만들기 끝 — 내보내기는 새벽 3시(이 맥 시계=베트남시간)"
